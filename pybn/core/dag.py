...
class DAG(Graph):
    ...
    def loadAllAncestors(self):
        ...
        for variable in self.variables:
            ...
            l = [key for key in self.transitiveClosureDict if (
                key != variable and self.transitiveClosureDict[key][varInd] == True)]
    ...
    def moralize(self):
        ...
        for v in allVstructures:
            ...
            moralizedDag.addEdge(
                (parentsOfVstructure[0], parentsOfVstructure[1]))
        return moralizedDag
